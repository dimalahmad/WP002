...
@section('title', 'Riwayat Blacklist OS')
...
@section('content')
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0 fw-bold text-danger">Riwayat Blacklist OS</h3>
                </div>
                <div class="col-sm-6 text-end">
                    <a href="{{ route('user.blacklist-os') }}" class="btn btn-secondary">
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            Swal.fire({
                                ...
                                window.location.href = "{{ route('user.blacklist-os') }}";
                            });
                        }
                    });
                });
